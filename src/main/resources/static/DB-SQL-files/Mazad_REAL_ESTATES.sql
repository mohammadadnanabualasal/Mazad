...
CREATE TABLE `REAL_ESTATES` (
  `real_state_id` int NOT NULL AUTO_INCREMENT,
  `real_state_type_id` int NOT NULL,
  `id` int NOT NULL,
  `ad_id` int DEFAULT NULL,
  PRIMARY KEY (`real_state_id`),
  UNIQUE KEY `REAL_ESTATES_real_state_id_uindex` (`real_state_id`),
  KEY `REAL_ESTATES_REAL_ESTATES_TYPE_type_id_fk` (`real_state_type_id`)
...
INSERT INTO `REAL_ESTATES` VALUES (4,2,2,8),(5,2,3,12),(6,4,4,16),(7,4,5,19);
