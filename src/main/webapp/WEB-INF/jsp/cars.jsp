    ...
    <div class="row card-strip">
        ...
        <div class="col-md-8">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="text-left">
                            ${car.getRelatedAdd().getTitle()}
                    </h3>
                </div>
            </div>
            <div class="row">
                <p>
                    <span class="badge badge-default">${car.getCar_maker()}: ${car.getModel()} (${car.getYear()})</span>
                </p>
                <p><span class="badge badge-default">${car.getTransmission_type()}</span></p>
                <p><span class="badge badge-default">${car.getFuel_type()}</span></p>
                <p><span class="badge badge-default">${car.getColor()}</span></p>
                <p><span class="badge badge-default">${car.getCar_condition()}</span></p>
                <p><span class="badge badge-default">${car.getKilometers()}</span></p>
            </div>
        </div>
        <div class="col-md-4">
