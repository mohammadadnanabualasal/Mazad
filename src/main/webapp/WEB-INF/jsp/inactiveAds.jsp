                ...
                <div class="col-md-8">
                    <div class="row">
                        <a class="profile-text" href="/profile/${entity.getRelatedAdd().getOwnerUser().getId()}">
                            <img src="/profileImage/${entity.getRelatedAdd().getOwnerUser().getId()}" width="20"
                                 height="20"
                    ...
                    <div class="col-12">
                        <div class="row">
                            <h3 class="text-left">
                                <a href="${entity.getEntityUrl()}"
                                   class="title-link">${entity.getRelatedAdd().getTitle()}</a>
                            </h3>
                        </div>
                        <div class="row">
                        ...
                        <c:if test="${entity.getClass() eq 'class com.example.mazad.entities.CarsEntity'}">
                            ...
                            <div class="row">
                                ...
                                <p><b class="card-lable"><spring:message code="addCar.label.transmission_type"/>:</b>
                                    <span
                        ...
                        <div class="row">
                            <div class="col-5">
                                <div class="text-center">
                                    <a href="/action/deleteAd/${entity.getRelatedAdd().getTypeId()}/${entity.getId()}"
                            ...
                            <div class="col-5">
                                <div class="text-center">
                                    <a href="/action/enableAd/${entity.getRelatedAdd().getTypeId()}/${entity.getId()}"
