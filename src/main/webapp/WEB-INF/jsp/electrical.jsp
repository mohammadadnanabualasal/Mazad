...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-6 login-form container-shadow">
            <div class="row padding-10">
                <div class="col-md-10">
                    <a class="profile-text" href="/profile/${electrical.getRelatedAdd().getOwnerUser().getId()}">
                        <img src="/profileImage/${electrical.getRelatedAdd().getOwnerUser().getId()}" width="50"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="myCarousel-${electrical.getRelatedAdd().getId()}" class="carousel slide"
                         data-ride="carousel">
                        <!-- Wrapper for slides -->
            ...
            <div class="container details">
                <div class="row">
                    <h2 class="title-link">${electrical.getRelatedAdd().getTitle()}</h2>
                    <br/>
                </div>
                <div class="col-md-12">
                <div class="row">
                    <p><b class="card-lable"><spring:message
                            code="electrical.label.country"/> </b>${electrical.getRelatedAdd().getCountry()} </p>
                </div>
                <div class="row">
                    <p><b class="card-lable"><spring:message code="electrical.label.city"/> </b><spring:message
                            code="${electrical.getRelatedAdd().getCity()}"/></p>
                </div>
                <div class="row">
                    <p><b class="card-lable"><spring:message
                            code="electricals.label.last_price"/> </b>${electrical.getRelatedAdd().getLastPrice()}</p>
                </div>
                <div class="row">
                    <p><b class="card-lable"><spring:message
                            code="electricals.label.description"/> </b>${electrical.getRelatedAdd().getAdDescription()}
                    </p>
                    <br/>
                </div>
                <div class="row">
                    ...
                    <p><b class="card-lable"><spring:message code="electricals.label.condition"/></b> <spring:message
                            code="condition.${electrical.getDeviceCondition()}"/></p>

                </div>
                <div class="text-center">
                    <form role="form" method="post" action="/action/newPrice" name="car">
                        <input type="number" id="firstPrice" name="newPrice" min="${electrical.getRelatedAdd().getLastPrice()}" max="2147483647" placeholder="your offer">
                        <input type="number" hidden name="adId" value="${electrical.getRelatedAdd().getId()}">
                        <input hidden name="redirectUrl" value="/electrical/${electrical.getId()}">
                        <br/>
